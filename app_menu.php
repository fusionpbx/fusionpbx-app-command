<?php
	...
	$apps[$x]['menu'][$y]['title']['he-il'] = "פקודה";
	...
	$apps[$x]['menu'][$y]['title']['ro-ro'] = "Comanda";
	...
	$apps[$x]['menu'][$y]['title']['ja-jp'] = "指示";
	$apps[$x]['menu'][$y]['title']['ko-kr'] = "명령";
