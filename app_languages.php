...
$text['title-command']['he-il'] = "פקודה";
...
$text['title-command']['ro-ro'] = "Comanda";
...
$text['title-command']['ja-jp'] = "指示";
$text['title-command']['ko-kr'] = "명령";
...
$text['label-result_type']['ro-ro'] = "Rezultat";
...
$text['description-command']['he-il'] = "מספק דרך נוחה לביצוע פקודות מערכת, PHP, מתג ו-SQL.";
...
$text['description-command']['ro-ro'] = "Oferă o modalitate convenabilă de a executa comenzi de sistem, PHP, comutare și SQL.";
...
$text['description-command']['zh-cn'] = "提供了一种便捷的方式来执行系统、PHP、switch 和 SQL 命令。";
$text['description-command']['ja-jp'] = "システム、PHP、スイッチ、SQL コマンドを実行する便利な方法を提供します。";
$text['description-command']['ko-kr'] = "시스템, PHP, 스위치 및 SQL 명령을 실행하는 편리한 방법을 제공합니다.";
